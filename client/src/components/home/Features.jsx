...
const Features = () => {
  ...
  return (
    ...
    <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5">
           <Zap width={14}/>
            <span>Simple resume workflow</span>
     </div>
     <Title title='Build your resume' description='Create a complete, professional resume with structured forms, live preview, template selection, and secure cloud storage.'/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">ATS-ready templates</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Choose clean resume layouts built for readability and applicant tracking systems.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Secure user workspace</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Registered users can save, edit, and manage resumes from a protected dashboard.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Print, save, and share</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Preview resumes in actual format, save through browser print, and share text or public links.</p>
                            </div>
                        </div>
                    </div>
                </div>
